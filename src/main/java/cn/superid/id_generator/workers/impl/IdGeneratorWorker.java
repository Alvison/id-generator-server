...
import cn.superid.id_generator.exceptions.*;
import cn.superid.id_generator.services.*;
...
public class IdGeneratorWorker implements IIdGeneratorWorker {
    ...
    @Autowired
    private IDbIdSequenceService dbIdSequenceService;
    @Autowired
    ...
    @Inject
    public IdGeneratorWorker(IIdMerger idMerger, IMachineClusterStateManager machineClusterStateManager, IServerGroupService serverGroupService, IDbIdSequenceService dbIdSequenceService, IDbRouter dbRouter) {
        this.idMerger = idMerger;
        this.machineClusterStateManager = machineClusterStateManager;
        this.serverGroupService = serverGroupService;
        this.dbIdSequenceService = dbIdSequenceService;
    ...
    public String nextId(String groupName) throws IdGeneratorException {
        ...
        Function<Void, Long> firstPartIdGenerator = new Function<Void, Long>() {
            ...
            public Long apply(Void aVoid) {
                return dbIdSequenceService.nextUniqueId();
            }
        };
